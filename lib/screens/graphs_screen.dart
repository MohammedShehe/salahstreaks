...
class _GraphsScreenState extends State<GraphsScreen> with SingleTickerProviderStateMixin {
            ...
            children: options.map((option) {
              return FilterChip(
                ...
                label: Text(option, style: TextStyle(
                  fontSize: 12,
                  color: selected == option ? Colors.white : AppThemeColors.textSecondary(context),
                )),
        ...
        child: DropdownButton<int>(
          ...
          items: List.generate(10, (index) {
            ...
            return DropdownMenuItem(
              ...
              value: year,
              child: Text('$year', style: TextStyle(color: AppThemeColors.textPrimary(context))),
            );
          }),
          dropdownColor: AppThemeColors.surface(context),
          style: TextStyle(color: AppThemeColors.textPrimary(context)),
    ...
    if (filteredLogs.isEmpty) {
      return Center(
        child: Text(
          ...
          style: TextStyle(color: AppThemeColors.textSecondary(context), fontSize: 16),
        ),
      );
    }
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(color: AppThemeColors.textSecondary(context), fontSize: 18),
          ),
          const SizedBox(height: 8),
          Text(
                  ...
                  if (value.toInt() < data.length) {
                    return Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(color: AppThemeColors.textPrimary(context), fontSize: 10),
              ...
              dotData: FlDotData(
                ...
                getDotPainter: (spot, percent, barData, index) {
                  return FlDotCirclePainter(
                    ...
                    strokeWidth: 2,
                    strokeColor: AppThemeColors.textPrimary(context),
                  );
                },
              ),
  ...
  Widget _buildBipolarChart(List<IbadatLog> logs) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          // Header with legend - FIXED OVERFLOW HERE
          Container(
              ...
              LineChartData(
                ...
                gridData: FlGridData(
                  ...
                  getDrawingHorizontalLine: (value) {
                    ...
                    return FlLine(
                      color: isZero 
                          ? AppThemeColors.textHint(context).withOpacity(0.6) 
                ...
                lineTouchData: LineTouchData(
                  ...
                  touchTooltipData: LineTouchTooltipData(
                    tooltipBgColor: AppThemeColors.surface(context),
                    ...
                    getTooltipItems: (List<LineBarSpot> touchedSpots) {
                      return touchedSpots.map((spot) {
                        ...
                        return LineTooltipItem(
                          ...
                          TextStyle(color: AppThemeColors.textPrimary(context), fontSize: 12),
                        );
                      }).toList();
                    },
                  ),
          ...
          // Bottom info with legend - FIXED OVERFLOW HERE
          const SizedBox(height: 8),
          Container(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Line',
                      style: TextStyle(
                        color: AppThemeColors.textPrimary(context).withOpacity(0.22),
                        fontSize: 9,
                      ),
                    ),
                  ],
